...
class HttpCode extends Base
{
    ...
    const HTTP__default = "HTTP/1.1 200 OK";
    ...
    const HTTP_408 = "HTTP/1.1 408 Request Time-out";
    ...
    const HTTP_414 = "HTTP/1.1 414 Request-URI Too Large";
    ...
    const HTTP_504 = "HTTP/1.1 504 Gateway Time-out";
}
